...
```
npm create cloudflare@latest -- --template=cloudflare/templates/gooner
```

A live public deployment of this template is available at [https://gooner.templates.workers.dev](https://gooner.templates.workers.dev)
